...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    atthentication_classes = (TokenAuthentication, )
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (
        ...
        # IsAuthenticatedOrReadOnly, # Allow read-only access to unauthenticated users
        IsAuthenticated # Deny read-only access to unauthenticated users
    )

    # Override perform_create method
    def perform_create(self, serializer):
        """Sets the user profile to the logged in user"""
        # Save user profile to serializer
